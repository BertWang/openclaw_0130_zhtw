...
export function renderApp(state: AppViewState) {
  ...
  const chatDisabledReason = state.connected ? null : strings.chatDisconnected;
    ...
    <div class="shell ${isChat ? "shell--chat" : ""} ${chatFocus ? "shell--chat-focus" : ""} ${state.settings.navCollapsed ? "shell--nav-collapsed" : ""} ${state.onboarding ? "shell--onboarding" : ""}">
      ...
      state.applySettings({
        ...
        navCollapsed: !state.settings.navCollapsed,
            ...
            title="${state.settings.navCollapsed ? strings.expandSidebar : strings.collapseSidebar}"
            aria-label="${state.settings.navCollapsed ? strings.expandSidebar : strings.collapseSidebar}"
          >
          ...
          <div class="brand">
            ...
            <div class="brand-text">
              <div class="brand-title">${strings.appTitle}</div>
              <div class="brand-sub">${strings.appSub}</div>
            </div>
          </div>
        </div>
        <div class="topbar-status">
          <div class="pill">
            ...
            <span class="mono">${state.connected ? strings.healthOk : strings.healthOffline}</span>
          </div>
      ...
      <aside class="nav ${state.settings.navCollapsed ? "nav--collapsed" : ""}">
        ...
        const groupLabel = (() => {
          switch (group.label) {
            case "Chat":
              return strings.groupChat;
            case "Control":
              return strings.groupControl;
            case "Agent":
              return strings.groupAgent;
            case "Settings":
              return strings.groupSettings;
            default:
              return (group as any).label;
          }
        })();
        return html`
        ...
        <div class="nav-group nav-group--links">
          <div class="nav-label nav-label--static">
            <span class="nav-label__text">${strings.resources}</span>
          </div>
          <div class="nav-group__items">
            <a
            ...
            >
              ...
              <span class="nav-item__text">${strings.docs}</span>
            </a>
            <a
              class="nav-item"
              href="/docs-zh"
      ...
      window.dispatchEvent(new PopStateEvent("popstate"));
            ...
            >
              <span class="nav-item__icon" aria-hidden="true">${icons.book}</span>
              <span class="nav-item__text">中文文檔</span>
            </a>
          </div>
        </div>
      </aside>
