...
// Section metadata - dynamically localized
export function getSectionMeta(): Record<string, { label: string; description: string }> {
  const strings = t();
  return {
    env: { label: strings.sectionEnv, description: strings.sectionEnvDesc },
    update: { label: strings.sectionUpdate, description: strings.sectionUpdateDesc },
    agents: { label: strings.sectionAgents, description: strings.sectionAgentsDesc },
    auth: { label: strings.sectionAuth, description: strings.sectionAuthDesc },
    channels: { label: strings.sectionChannels, description: strings.sectionChannelsDesc },
    messages: { label: strings.sectionMessages, description: strings.sectionMessagesDesc },
    commands: { label: strings.sectionCommands, description: strings.sectionCommandsDesc },
    hooks: { label: strings.sectionHooks, description: strings.sectionHooksDesc },
    skills: { label: strings.sectionSkills, description: strings.sectionSkillsDesc },
    tools: { label: strings.sectionTools, description: strings.sectionToolsDesc },
    gateway: { label: strings.sectionGateway, description: strings.sectionGatewayDesc },
    wizard: { label: strings.sectionWizard, description: strings.sectionWizardDesc },
    // Additional sections
    meta: { label: strings.sectionMeta, description: strings.sectionMetaDesc },
    logging: { label: strings.sectionLogging, description: strings.sectionLoggingDesc },
    browser: { label: strings.sectionBrowser, description: strings.sectionBrowserDesc },
    ui: { label: strings.sectionUi, description: strings.sectionUiDesc },
    models: { label: strings.sectionModels, description: strings.sectionModelsDesc },
    bindings: { label: strings.sectionBindings, description: strings.sectionBindingsDesc },
    broadcast: { label: strings.sectionBroadcast, description: strings.sectionBroadcastDesc },
    audio: { label: strings.sectionAudio, description: strings.sectionAudioDesc },
    session: { label: strings.sectionSession, description: strings.sectionSessionDesc },
    cron: { label: strings.sectionCron, description: strings.sectionCronDesc },
    web: { label: strings.sectionWeb, description: strings.sectionWebDesc },
    discovery: { label: strings.sectionDiscovery, description: strings.sectionDiscoveryDesc },
    canvasHost: { label: strings.sectionCanvasHost, description: strings.sectionCanvasHostDesc },
    talk: { label: strings.sectionTalk, description: strings.sectionTalkDesc },
    plugins: { label: strings.sectionPlugins, description: strings.sectionPluginsDesc },
  };
}

// Keep static version for backward compatibility / export
...
export function renderConfigForm(props: ConfigFormProps) {
  ...
  if (!props.schema) {
    return html`<div class="muted">${strings.schemaUnavailable}</div>`;
  }
  const schema = props.schema;
  const value = props.value ?? {};
  if (schemaType(schema) !== "object" || !schema.properties) {
    return html`<div class="callout danger">${strings.unsupportedSchemaUseRaw}</div>`;
  }
    ...
    return html`
      <div class="config-empty">
        ...
        <div class="config-empty__text">
          ${searchQuery
        ? strings.noSettingsMatch(searchQuery)
        : strings.noSettingsInSection}
        </div>
      </div>
    `;
  }
